...
import { LogOut, Cloud, Check, Loader2, UserCheck, ShieldCheck, ArrowRightLeft } from 'lucide-react';
          ...
          <div className="space-y-1.5 pt-1 border-t border-[#EBE8E0]">
            ...
            {onOpenMultiAppModal && (
              <button
                ...
                className="w-full flex items-center space-x-2 px-3 py-2 text-xs font-semibold text-[#2D5A43] bg-[#E7EFEA] hover:bg-[#D8E6DD] rounded-xl transition-colors cursor-pointer text-left border border-[#C3D9CD]"
              >
                <ArrowRightLeft className="w-4 h-4 text-[#2D5A43]" />
                <span>Sync GitHub Pages & Cloud</span>
              </button>
            )}
