  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-[66px] h-[45px] border-2 border-[#DCD6CB] rounded-[26px] flex items-center justify-center space-x-1.5 px-2 bg-[#F4F1EA] hover:bg-white text-[#1A1A1A] transition-all shadow-xs cursor-pointer group"
        title={isAllSelected ? "Toutes les boulangeries" : `${activeBakery?.name || 'Boulangerie'} - Cliquez pour changer de périmètre`}
      >
        <div
          className="w-6 h-6 rounded-full flex items-center justify-center text-white shrink-0 shadow-2xs transition-transform group-hover:scale-105"
